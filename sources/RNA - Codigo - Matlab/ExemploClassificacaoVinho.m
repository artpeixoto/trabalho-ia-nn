...
% generalize to accurately classify wines that were not used to design the
% solution.
%
%% Why Neural Networks?
...
%
% The network will be designed by using the attributes of neighborhoods to
% train the network to produce the correct target classes.
%
%% Preparing the Data
...
% consisting of two zeros and a 1 in the location of the associated winery.
%
